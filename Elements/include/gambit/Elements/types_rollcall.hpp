...
///  by the GAMBIT backend harvester (for Core-wide use).
///  It will also be included in the per-module rollcall
///   ${MODULE}/include/gambit/${MODULE}/${MODULE}_backend_types_rollcall.hpp
///  for each module that declares a dependency on backend Z
///  via BACKEND_OPTION or NEEDS_CLASSES_FROM in its rollcall.
///  These per-module headers are auto-generated by backend_harvester.py.
///
///  MIXED-USE TYPES
///  --------------- 
...
#include "gambit/Backends/backend_types_rollcall.hpp" // All backend types (for Core; auto-generated by backend harvester)
