...
namespace Gambit
{
  ...
  // Functor class methods
    ...
    /// Must be called on every active functor at every scan point, regardless of whether
    /// that functor is being recalculated, so that a cached value still gets printed
    /// against the new point.
