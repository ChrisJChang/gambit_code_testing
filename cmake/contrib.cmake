...
option(FORCE_EXCLUDE_YODA "Force exclusion of YODA even when ColliderBit is included" OFF)
if(";${GAMBIT_BITS};" MATCHES ";ColliderBit;" AND NOT FORCE_EXCLUDE_YODA)
  message("   ColliderBit included, so YODA is included too")
  set(WITH_YODA ON)
else()
  set(WITH_YODA OFF)
  if(FORCE_EXCLUDE_YODA AND ";${GAMBIT_BITS};" MATCHES ";ColliderBit;")
    message("${BoldCyan} X FORCE_EXCLUDE_YODA is ON: excluding YODA from GAMBIT configuration (YODA-dependent ColliderBit functions will be deactivated).${ColourReset}")
  else()
...
if(";${GAMBIT_BITS};" MATCHES ";ColliderBit;")
  ...
  # contrib depends on YODA (unless force-excluded for compilation-only use)
  if(EXCLUDE_YODA AND NOT FORCE_EXCLUDE_YODA)
